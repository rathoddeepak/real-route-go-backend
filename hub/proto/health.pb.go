...
type HealthCheckResponse struct {
	...
	Status HealthCheckResponse_ServingStatus `protobuf:"varint,1,opt,name=status,proto3,enum=justify.HealthCheckResponse_ServingStatus" json:"status,omitempty"`
}
...
var file_health_proto_rawDesc = []byte{
	0x0a, 0x0c, 0x68, 0x65, 0x61, 0x6c, 0x74, 0x68, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x07,
	0x6a, 0x75, 0x73, 0x74, 0x69, 0x66, 0x79, 0x22, 0x2e, 0x0a, 0x12, 0x48, 0x65, 0x61, 0x6c, 0x74,
	...
	0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x22, 0xaa, 0x01, 0x0a, 0x13, 0x48, 0x65, 0x61, 0x6c,
	...
	0x2a, 0x2e, 0x6a, 0x75, 0x73, 0x74, 0x69, 0x66, 0x79, 0x2e, 0x48, 0x65, 0x61, 0x6c, 0x74, 0x68,
	...
	0x57, 0x4e, 0x10, 0x03, 0x32, 0x96, 0x01, 0x0a, 0x06, 0x48, 0x65, 0x61, 0x6c, 0x74, 0x68, 0x12,
	0x44, 0x0a, 0x05, 0x43, 0x68, 0x65, 0x63, 0x6b, 0x12, 0x1b, 0x2e, 0x6a, 0x75, 0x73, 0x74, 0x69,
	0x66, 0x79, 0x2e, 0x48, 0x65, 0x61, 0x6c, 0x74, 0x68, 0x43, 0x68, 0x65, 0x63, 0x6b, 0x52, 0x65,
	...
	0x6e, 0x73, 0x65, 0x22, 0x00, 0x12, 0x46, 0x0a, 0x05, 0x57, 0x61, 0x74, 0x63, 0x68, 0x12, 0x1b,
	0x2e, 0x6a, 0x75, 0x73, 0x74, 0x69, 0x66, 0x79, 0x2e, 0x48, 0x65, 0x61, 0x6c, 0x74, 0x68, 0x43,
	0x68, 0x65, 0x63, 0x6b, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x1c, 0x2e, 0x6a, 0x75,
	0x73, 0x74, 0x69, 0x66, 0x79, 0x2e, 0x48, 0x65, 0x61, 0x6c, 0x74, 0x68, 0x43, 0x68, 0x65, 0x63,
	0x6b, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x00, 0x30, 0x01, 0x42, 0x11, 0x5a,
...
var file_health_proto_goTypes = []interface{}{
	(HealthCheckResponse_ServingStatus)(0), // 0: justify.HealthCheckResponse.ServingStatus
	(*HealthCheckRequest)(nil),             // 1: justify.HealthCheckRequest
	(*HealthCheckResponse)(nil),            // 2: justify.HealthCheckResponse
}
var file_health_proto_depIdxs = []int32{
	0, // 0: justify.HealthCheckResponse.status:type_name -> justify.HealthCheckResponse.ServingStatus
	1, // 1: justify.Health.Check:input_type -> justify.HealthCheckRequest
	1, // 2: justify.Health.Watch:input_type -> justify.HealthCheckRequest
	2, // 3: justify.Health.Check:output_type -> justify.HealthCheckResponse
	2, // 4: justify.Health.Watch:output_type -> justify.HealthCheckResponse
